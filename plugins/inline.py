...
buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://github.com/Jimicreator/player-bot"),
            ]
         ]
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@AsmSafone | @Jimi_Bots 👑</b>", disable_web_page_preview=True),
